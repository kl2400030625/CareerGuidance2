...
export function getCareers() {
    return loadOrSeed(CAREERS_KEY, DEFAULT_CAREERS);
}
export function saveCareers(careers) {
    save(CAREERS_KEY, careers);
}
export function getAdminResources() {
    return loadOrSeed(ADMIN_RESOURCES_KEY, DEFAULT_ADMIN_RESOURCES);
}
export function saveAdminResources(resources) {
