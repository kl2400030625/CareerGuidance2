...
export default function Quiz() {
  ...
  const getCareerMatch = () => {
    if (answers.length < 3) return 'Software Engineer'
          ...
          {!showResults ? (
              ...
              <div className="space-y-3">
                {QUIZ_QUESTIONS[currentQuestion].options.map((option, idx) => (
                  <motion.button
                    ...
                    whileTap={{ scale: 0.98 }}
                    className="w-full p-4 text-left border-2 border-gray-200 rounded-lg hover:border-indigo-600 hover:bg-indigo-50 transition-all font-semibold text-slate-900 group"
                  >
            ...
            >
              ...
              <motion.div
                ...
                className="bg-gradient-to-r from-indigo-600 to-pink-600 rounded-xl p-8 text-white mb-8"
              >
